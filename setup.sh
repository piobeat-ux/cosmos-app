...
echo " Начинаю создание проекта Cosmos Radio..."

# Удаляем старые файлы если есть
rm -rf assets index.html hero-bg.jpg sound-waves.jpg

# Создаем структуру папок
mkdir -p src/{lib,types,contexts,components,pages,admin}
mkdir -p public
...
<html lang="ru">
  <head>
    ...
    <meta name="description" content="Cosmos Radio - Ваше любимое онлайн радио" />
    <title>Cosmos Radio - Онлайн Радио</title>
  </head>
  <body>
    <div id="root"></div>
...
echo ""
echo "⚠️  ВАЖНО: Теперь нужно создать файлы src/"
